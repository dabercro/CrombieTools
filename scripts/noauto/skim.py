...
parser.add_argument('-r', '--run', metavar='EXPR', dest='runExpr', default='runNumber', help='Set the expression for Run Number.')
parser.add_argument('-l', '--lumi', metavar='EXPR', dest='lumiExpr', default='lumiNumber', help='Set the expression for Lumi Number.')
parser.add_argument('-e', '--event', metavar='EXPR', dest='eventExpr', default='eventNumber', help='Set the expression for Lumi Number.')
