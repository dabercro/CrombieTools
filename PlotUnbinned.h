#ifndef MITPLOTS_PLOT_PLOTUNBINNED_H
#define MITPLOTS_PLOT_PLOTUNBINNED_H
...
class PlotUnbinned : public PlotBase
{
 public:
  PlotUnbinned();
  virtual ~PlotUnbinned();
  
  void                         SetExprX                ( TString expr )                                 { fInExprX = expr;              }
  void                         AddExprX                ( TString expr )                                 { fInExprXs.push_back(expr);    }
  void                         AddChannelMC            ( TString channel, Bool_t isMC )                 { fChannels.push_back(channel); 
                                                                                                          fisMCs.push_pack(isMC); }
 ...
 private:
  ...
  std::vector<TString>       fChannels;
  std::vector<Bool_t>        fisMCs;
